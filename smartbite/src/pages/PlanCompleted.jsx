...
export default function PlanCompleted() {
    ...
    const mealPlanPrompt=`Generar planes de cenas deliciosos y bajos en calorias para personas con sobrepeso que quieren reducir peso.\n\n    \n  Generar un plan de cenas para 7 días, incluyendo una variedad de comidas deliciosas, jugosas y bajas en calorías. Evitar sugerir comidas que el usuario no ha disfrutado en el pasado o que contengan los siguientes ingredientes:[no ingredientes]. El plan de comidas debe ser diverso, incluir múltiples grupos alimentarios y proporcionar al usuario una dieta equilibrada [estilo de vida].\n  \n  Si alguna de las comidas es seca, como una ensalada, arroz o quinoa se incluirá en el nombre de la comida una salsa o aderezo delicioso.\n  \n  La respuesta solo sera un objeto json  con dos objetos dentro, un arreglo llamado comida que contiene una lista de comidas, 7 en total, cada una con un atributo \"nombre\", un atributo \"tiempo\" que indica el tiempo aproximado que tomara preparar la comida en minutos , un atributo 'dia' que indica para que dia de la semana esta pensado ese plato, del 1 al 7 y un atributo url vacio. El otro objeto se llamara compras y tendra un arreglo con ingredientes necesarios para las comidas sugeridas. Cada ingrediente tendra atributos 'nombre', 'unidad' y otro 'cantidad' y que no se escriba nada hasta que se termine de mandar los JSON`
            ...
            <div className="m-5 d-flex flex-wrap justify-content-center">
                ...
                comidas.map((recipe,index) => (
                    <div className="d-flex justify content-center">
                        ...
                        <CardRecipe recipe={recipe} key={recipe.dia} alterRecipeFun={()=>modifyMealPlan(recipe.dia,comidas,"","")} comida={comidas} dia={recipe.dia} />
                    </div>
